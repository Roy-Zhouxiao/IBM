...
def parse_opt():
    ...
    # 改：选择模型
    parser.add_argument('--weights', nargs='+', type=str, default='D:/yolo data/best.pt', help='model.pt path(s)')
    # 改：选择检测素材
    parser.add_argument('--source', type=str, default='D:/data/videos/tree (1).mp4',
...
if __name__ == "__main__":
    # image = cv2.imread('D:/data/pictures/plane (2).jpg')
    # main(my_parse_opt(image))
    opt = parse_opt()
    main(opt)
